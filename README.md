...
- Überwacht `%LocalAppData%` aller Benutzerprofile auf die Erstellung von `work4all GmbH`-Ordnern
- Überwacht alle Desktop-Verzeichnisse (inkl. Public Desktop) auf neue `.lnk`-Verknüpfungen
...
- Durchsucht alle Benutzerprofile nach `%LocalAppData%\work4all GmbH\work4all\*`
...
- **.NET 8 SDK** zum Kompilieren (oder fertige Binaries verwenden)
